      ...
      <div className="nav">
        <div className="upperNav">
          <div className="col-lg-4">
            <input
              ...
              aria-describedby="Contains Search Feature"
            />
          </div>
        ...
        <div className="lowerNav">
          ...
          <Link to="/shirts" path={Shirts} style={{ textDecoration: "none" }}>
            <div className="navButtons">Shirts</div>
          </Link>
          <Link to="/pants" path={Pants} style={{ textDecoration: "none" }}>
            <div className="navButtons">Pants</div>
          </Link>
          <Link to="/bowties" path={BowTies} style={{ textDecoration: "none" }}>
            <div className="navButtons">BowTies</div>
          </Link>
          <Link
            to="/neckties"
            path={NeckTies}
          ...
          >
            <div className="navButtons">NeckTies</div>
          </Link>
          <Link
            to="/skinnyties"
            path={SkinnyTies}
            style={{ textDecoration: "none" }}
          >
            <div className="navButtons">SkinnyTies</div>
          </Link>
          <Link to="/tiebars" path={TieBars} style={{ textDecoration: "none" }}>
            <div className="navButtons">TieBars</div>
          </Link>
          <Link to="/socks" path={Socks} style={{ textDecoration: "none" }}>
            <div className="navButtons">Socks</div>
          </Link>
          <Link
            to="/pocketsquares"
            path={PocketSquares}
            style={{ textDecoration: "none" }}
          >
            <div className="navButtons">PocketSquares</div>
          </Link>
          <Link
            to="/accessories"
            path={Accessories}
            style={{ textDecoration: "none" }}
          >
            <div className="navButtons">Accessories</div>
          </Link>
          <Link to="/wedding" path={Wedding} style={{ textDecoration: "none" }}>
            <div className="navButtons">Wedding</div>
          </Link>
          <Link to="/gifts" path={Gifts} style={{ textDecoration: "none" }}>
            <div className="navButtons">Gifts</div>
          </Link>
        </div>
      </div>
    );
